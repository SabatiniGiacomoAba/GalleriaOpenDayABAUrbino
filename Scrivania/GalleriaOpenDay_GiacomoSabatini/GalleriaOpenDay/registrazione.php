...
function addNodeXml($xml,$name,$surname,$username,$password,$realm,$definition,$email,$studies,$s){
...
if($result[0]){
        ...
        echo "<a href=\"registrazione.html\"> Torna alla pagina di Registrazione </a>";
    	  ...
    	  $xml = addNodeXml($xml,$name,$surname,$username,$password,$realm,$definition,$email,$studies,$s);
    	  $xml->asXML("dati_utenti.xml");
    	  echo "Registrazione terminata con successo<br>"; 
          writeSchedaNode($name,$surname,$username,$password,$realm,$definition,$email,$studies,$s);
