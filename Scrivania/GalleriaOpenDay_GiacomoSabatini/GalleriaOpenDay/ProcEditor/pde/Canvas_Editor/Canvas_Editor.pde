...
void setup() {
        ...
        dir_forme_geometriche = "../../php/tempde/";
        String files_forme_geometriche[] = loadStrings("../../php/temp.txt");
    ...
    String bcolor = children[i].getString("border-color");
        if ( bcolor != ""){
                    bcolor = "FF" + bcolor.substring(1);
                }
    ...
    log = append(log, id + ", " + ", " + colors + bcolor + ", " + x1 + ", " + y1 + ", " + x2 + ", " + y2 +", " + name);
                ...
                log = append(log, " red " + red(color(unhex(bcolor))) );
                log = append(log, " blue " + blue(color(unhex(bcolor))) );
                log = append(log, " green " + green(color(unhex(bcolor))) );
                smooth();
                int hi = unhex(colors);
                 int bhi = unhex(bcolor);
