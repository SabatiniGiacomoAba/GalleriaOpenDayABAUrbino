//// JavaScript Document    
   ...
   function sentFileNameChecker()
   {
     if(confirm("!____Attention____! \n \n Maybe you are going to overwrite a file \n that could have the same name. \n \n Proceed?"))
     {
        return true;     
     }
     else {
     	 ...
     	 if (TrOn==false) {
     	    ...
     	    window.onmousemove = function CursorMove(e) {        	    	
     	       ...
     	       window.onclick = function WriteTrPos(e)
                 ...
                 document.getElementById("tempxml").value += (v.flush());
                document.getElementById("tempxml").value.replace("</layers><?xml version=\"1.0\" ?>\n<layers>"," ");
                  document.getElementById("tempXML").value.replace("</layers><?xml version=\"1.0\" ?>\n<layers>"," ");
       	      }
...
function lineOn(e)
 ...
 //menu    
    ...
    //BUTTONS 
  /*function TxtRemoverDEMO() {
  	var line1 = "</layers><?xml version=\"1.0\" ?>";
  	 /*document.getElementById("tempxml").value.replace(line1," ");
    document.getElementById("tempXML").value.replace(line1," ");
    var fs = document.getElementById("tempxml").value;
    var txt = new String(fs);
    
     document.getElementById("test").innerText = txt;
     var resSrc = txt.search("<layers>");
     document.getElementById("test2").innerText = resSrc;
     
     if (resSrc > 0) {
     	 document.getElementById("test3").innerText = txt;
     	var str = document.getElementById("test3").innerHTML;
     	/*var res = str.replace(/[</]|[>]|layers/g ,"ciaomondo");
     	document.getElementById("test3").innerHTML = res;
     	var i = 0;
     	var counter = 0;
     	var lines = fs.split('\n');
     	//str = document.getElementById("test3").innerText = lines[4];

       lines[3] = " ";
       
        lines[4] = " ";
        var rejoined = lines.join("\n");
        str = document.getElementById("test3").innerText = rejoined;
    ...
    function TxtRemover() {
    	var fs = document.getElementById("tempxml").value;
    		...
    		if (lineslen > 4) {
    			...
    			for (i = 3; i < (lineslen-2); i += 3) {
    				
    				lines[i] = " ";
    		
    				
  }
   			for (f = 4; f< (lineslen-2); f += 3) {
   ...
   function openLoadFile()
   {
      ...
      var loadscreen = document.getElementById("loadPage");
     
      	 if (LoadActive==false) {
     	 	
     	   loadscreen.classList.add("PanOn");
     	    LoadActive = true;
     	 	
     	 }
     	 else {
     	 	loadscreen.classList.remove("PanOn");
     	 	LoadActive = false;
     	 }
     }
   function LoadFile() {
          	var filelist = require("filelist");
          	var txt = filelist.readFileSync("HostedFilesList.txt").toString('utf-8');
   	      var listfiles = txt.split("\n");
   	      document.getElementById("fileslist").innerHTML = listfiles;
   	      
   	}
   function closeLoadFile()
   {
   	  var loadscreen = document.getElementById("loadPage");
       loadscreen.classList.remove("PanOn");
     	 LoadActive = false;
