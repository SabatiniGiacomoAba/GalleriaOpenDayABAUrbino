...
{ 
      ...
      if ($xml != NULL) {
      	...
      	$peso = $xml->info_file->attributes()->peso;
      	//echo "<br>Mio ".$xml->info_file->attributes()->username;
      }
      
      echo "<tr><td align=\"center\" valign=\"middle\"><canvas data-processing-sources=\"upload_pde/$sfiles\"></canvas></td><td align=\"left\" valign=\"top\"> <strong>
      <em>Nome file</em></strong>: $sfiles <br> <strong>
      <em>Nome utente</em>
      </strong> : $user
      <br> 
      <strong>
