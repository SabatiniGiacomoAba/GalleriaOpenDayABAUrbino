...
{ 
      ...
      echo "<tr><td align=\"center\" valign=\"middle\"><canvas data-processing-sources=\"upload_pde/$sfiles\"></canvas></td><td align=\"left\" valign=\"top\"> <strong><em>Nome file</em></strong>: $sfiles <br> <strong><em>Nome utente</em></strong> : $user
      <br> <strong><em>Data</em></strong> : $data <br> <strong><em>Ora </em></strong>: $ora </td></tr>";
} 
?>
</table>
</center>
