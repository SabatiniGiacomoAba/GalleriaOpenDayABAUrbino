...
//
function addNodeGraphicsXml($xml,$user,$tipo,$color,$cx1,$cy1,$cx2,$cy2, $cx3, $cy3, $cx4, $cy4, $cx5, $cy5,$contorno){
	...
	$nodo->addAttribute('x5',$cx5);
	$nodo->addAttribute('y5',$cy5);
	$nodo->addAttribute('area',$contorno);
	return($xml);
}
session_start();
//
...
if(!isLogged())   {//se non è loggato torna al form e lo script termina
         ...
         exit;  
			...
			echo (" nella posizione: $cx1 , $cy1 , $cx2 , $cy2 , $cx3 , $cy3 , $cx4 , $cy4 , $cx4 , $cy5 ,$cx5 <br>");
			if ( (strcmp($tipo, "punto") == 0) || (strcmp($tipo, "linea") == 0 ) || (strcmp($tipo, "rettangolo") == 0 ) || (strcmp($tipo, "ellisse") == 0 ) || (strcmp($tipo, "pentagono") == 0 ) || (strcmp($tipo, "triangolo") == 0 ) || (strcmp($tipo, "spezzata") == 0 )){
				//echo ("punto<br>");
				addNodeGraphicsXml($xml,$user,$tipo,$colore,$cx1,$cy1,$cx2,$cy2,$cx3, $cy3,$cx4,$cy4,$cx5,$cy5,$contorno);
			}else
