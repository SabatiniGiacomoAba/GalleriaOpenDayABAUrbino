    ...
    log = append(log, id + ", " + user + ", " + colors + ", " + x1 + ", " + y1 + ", " + x2 + ", " + y2 +", " + name);
      ...
      ellipse(x1, y1,3,3);
                        ...
                        line(x1,y1,x2,y1);
                           ...
                           /*line(x1,y1,x2,y1);
                               line(x2,y1,x2 +((7*(x2-x1))/22),((x2+x1)/2));
                                  line(x2 + ((7*(x2-x1))/22),((x2+x1)/2), (x2+x1)/2, ((3*((x2+x1)/2))/2));
                                     line((x2+x1)/2, ((3*((x2+x1)/2))/2), x1-((7*(x2-x1))/22), ((x2+x1)/2));
                                          line(x1-((7*(x2-x1))/22), ((x2+x1)/2),x1,y1);*/
