...
<body >
 ...
 <div id="proceditor" class="proContainer">
     ...
     <div id="leftPanel" class="leftPanel" style=" overflow: scroll;">
         <div id="layers" class="layers">
            
         </div>
         <div id="OptionPanel" style="margin:auto; width:200px;">
            <form id="TrPan" name="trPan" style="position:relative; z-index: 3; margin: auto;" class="PanOff">
                <h3>Triangle</h3>
                <h4>A</h4> 
