...
void setup() {
        size(640, 640);
        background(250);    
        pg = createGraphics(640, 640, P3D,"galleria_processing.png");
	pg.beginDraw();
        ...
        pg.fill(0);
        pg.text("Accademia di Belle Arti di Urbino - OpenDay - " + data_odierna, 10, 630);
	pg.endDraw();
	//image(pg,0,0,640,640);
	//pg.save("galleria_processing.png");
